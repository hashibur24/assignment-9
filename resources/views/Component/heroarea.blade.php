<section class="pb-5 bg-light"><div class="container pt-5">
          <div class="row align-items-center mb-5">
            <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
              <h2 class="display-4 fw-bold mb-5">I love to create beautiful and efficient websites</h2>
              ...
              <div class="d-flex flex-wrap"><a class="btn btn-primary me-2 mb-2 mb-sm-0" href="/project">Discover</a><a class="btn btn-outline-secondary mb-2 mb-sm-0" href="/contact">Contact Me</a></div>
            </div>
            <div class="col-12 col-lg-6 offset-lg-1">
              <img class="img-fluid" src="{{asset('bootstrap5-plain-assets/images/pic.jpg')}}" alt="">
            </div>
