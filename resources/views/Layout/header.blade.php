<nav class="navbar sticky-top bg-primary navbar-expand-lg navbar-light py-4 shadow-sm">
        <div class="container">
          <a class="navbar-brand" href="/">
            <img class="img-fluid" src="{{asset('bootstrap5-plain-assets/logos/projectlogo.png')}}" alt="" width="96px">
          </a>
          ...
          <div class="collapse navbar-collapse" id="nav06">
            ...
            <li class="nav-item me-4"><a class="nav-link" href="/home">Home</a></li>
              <li class="nav-item me-4"><a class="nav-link" href="/about">About Me</a></li>
